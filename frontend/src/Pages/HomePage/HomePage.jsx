		...
		<main className={styles.container}>
			<section className={styles.hero}>
				<div className={styles.heroText}>
					<h1>
						Rescuing <span className={styles.shade}>Food</span> Waste Through
						Community <span className={styles.shade}>Action</span>
					</h1>
					<div className={styles.description}>
						<p>
							Connecting{" "}
							<span className={styles.shade}>SMEs, Sponsors & People</span> in
							need
						</p>
			...
			<section className={styles.section} id="about-us">
				...
				<h3>
					Reducing <span className={styles.shade}>Food</span> Waste Through
					Community <span className={styles.shade}>Action</span>
				</h3>
				...
				<div className={styles.ourProfile}>
					...
					<section className={styles.grid}>
						...
						<div className={styles.mission}>
							<h3>Mission</h3>
							<p>
								To reduce food waste and fight hunger by creating a trusted
								digital platform that connects restaurants, sponsors, and
								communities, ensuring surplus food reaches those who need it
								most.
							</p>
						</div>
					</section>
